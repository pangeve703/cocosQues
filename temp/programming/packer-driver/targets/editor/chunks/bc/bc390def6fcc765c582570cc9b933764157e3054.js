      ...
      _export("BetAgain", BetAgain = (_dec = ccclass('BetAgain'), _dec2 = property(Node), _dec(_class = (_class2 = class BetAgain extends Component {
        ...
        betAllAgain() {
          this.tiles.children.forEach(childNode => {
            const betZoneComponent = childNode.getComponentInChildren(_crd && BetZoneComponent === void 0 ? (_reportPossibleCrUseOfBetZoneComponent({
              error: Error()
...
//# sourceMappingURL=bc390def6fcc765c582570cc9b933764157e3054.js.map