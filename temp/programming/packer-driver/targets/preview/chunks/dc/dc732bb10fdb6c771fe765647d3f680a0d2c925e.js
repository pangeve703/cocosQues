    ...
    execute: function () {
      ...
      _export("ChipManager", ChipManager = (_dec = ccclass('ChipManager'), _dec2 = property(Node), _dec(_class = (_class2 = class ChipManager extends Component {
        ...
        onselectedChipClick() {
          ...
          var selectedChipPosition = this.selectedChip.getPosition(); // Exclude the selected chip and sort the remaining chips by value in ascending order
        ...
        loadAndAnimateChip(chipConfig, index, totalChips, centerPosition) {
          ...
          resources.load(chipConfig.prefabPath, Prefab, (err, prefab) => {
            ...
            var chipNode = instantiate(prefab); // Set its initial position to the center (default coin position)
