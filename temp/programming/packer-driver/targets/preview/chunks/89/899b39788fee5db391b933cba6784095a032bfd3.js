  ...
  return {
    ...
    execute: function () {
      ...
      _export("BetZoneComponent", BetZoneComponent = (_dec = ccclass('BetZoneComponent'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Node), _dec(_class = (_class2 = class BetZoneComponent extends Component {
        ...
        placeChip() {
          var chipNode = instantiate(this.chipManager.selectedChip.children[0]);
          var chipComponent = chipNode.getComponent('ChipComponent');
          var chipValue = (chipComponent == null ? void 0 : chipComponent.chipValue) || 0;
        ...
        updateChips() {
          ...
          this.activeChips = [];
          var remainingValue = this.totalValue;
          var sortedChips = (_crd && ChipConfig === void 0 ? (_reportPossibleCrUseOfChipConfig({
            error: Error()
        ...
        animateChipPlacement(chipNode, stackHeight) {
          ...
          var abovePosition = new Vec3(nodePosition.x, nodePosition.y + 20, nodePosition.z);
          var targetPosition = new Vec3(nodePosition.x, nodePosition.y + stackHeight, nodePosition.z);
...
//# sourceMappingURL=899b39788fee5db391b933cba6784095a032bfd3.js.map